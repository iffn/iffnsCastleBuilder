...
public class NodeWallSystem : BaseGameObject
{
    ...
    public override void Setup(IBaseObject superObject)
    {
        ...
        this.linkedFloor = superObject as FloorController;
    ...
    public override void ApplyBuildParameters()
    {
        ...
        {
            UnityMeshManager currentCylinder = GameObject.Instantiate(NodeWallEndingCylinderTemplate.gameObject).GetComponent<UnityMeshManager>();
