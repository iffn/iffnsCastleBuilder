...
namespace iffnsStuff.iffnsCastleBuilder
{
    public class FloorController : BaseGameObject
    {
        ...
        {
            bottomFloorHeightParam = new MailboxLineRanged("Bottom floor height [m]", CurrentMailbox, Mailbox.ValueType.buildParameter, 1f, 0.05f, 0.25f);
            wallBetweenHeightParam = new MailboxLineRanged("Wall height [m]", CurrentMailbox, Mailbox.ValueType.buildParameter, 10f, 0.2f, 2.75f);
