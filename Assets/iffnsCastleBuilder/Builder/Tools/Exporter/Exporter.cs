...
public class Exporter : MonoBehaviour
{
    ...
    class ObjectGroup
    {
        ...
        {
            this.currentInfo.Add(newInfo: newInfo, originalTransform: originalTransform, thisTransform: worldTransform);
        }
    ...
    */
    ...
    public class ExportProperties
    {
        ...
        public ExportProperties()
        {
            ...
            this.floorSeparation = new MailboxLineDistinctNamed(name: "Floor separation", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter, entries: floorSeparationStrings);

            this.separateDummyObjects = new MailboxLineBool(name: "Separate dummy objects", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);

            this.materialIdentifier = new MailboxLineBool(name: "Material identifier", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);
            this.colliderIdentifier = new MailboxLineBool(name: "Collider identifier", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);
            this.hierarchyIdentifier = new MailboxLineBool(name: "Hierarchy identifier", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);
            this.includeSpecialObjects = new MailboxLineBool(name: "Include special objects", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);

            this.groupMaterials = new MailboxLineBool(name: "Group materials", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);
            this.includeInvisibleMeshes = new MailboxLineBool(name: "Include invisible meshes", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter);

            this.upDirection = new MailboxLineDistinctNamed(name: "UpDirection", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter, entries: UpDirectionStrings);
            this.outputFormat = new MailboxLineDistinctNamed(name: "Output format", objectHolder: mailbox, valueType: Mailbox.ValueType.buildParameter, entries: OutputFormatStrings);
        }
