...
public class NavigationTools : MonoBehaviour
{
    ...
    void UpdateFloorNumbers()
    {
        ...
        {
            GameObject currentNumber = GameObject.Instantiate(FloorNumberTemplate);
    ...
    void ShowBlockLinesAroundFocus(VirtualBlock focusBlock)
    {
        ...
        {
            GameObject.Destroy(currentLineHolder);
        }
        ...
        */
        ...
        {
            LineRenderer currentLine = GameObject.Instantiate(BlockLineTemplate).transform.GetComponent<LineRenderer>();
