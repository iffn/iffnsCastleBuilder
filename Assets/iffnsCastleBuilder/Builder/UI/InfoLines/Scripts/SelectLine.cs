...
public class SelectLine : ControlLine
{
    ...
    public void SetUp(string text, UnityEngine.Events.UnityAction<int> ReturnFunctionScript, List<string> lines, List<DelegateLibrary.VoidFunction> additionalCalls = null)
    {
        base.SetUp(text);
