...
public class NonCardinalWall : OnFloorObject
{
    ...
    */
    ...
    void initializeBuildParameterLines()
    {
        ...
        MainMaterial = new MailboxLineMaterial(name: "Main material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        SecondMaterial = new MailboxLineMaterial(name: "Second material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        CeilingMaterial = new MailboxLineMaterial(name: "Ceiling material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultCeiling);
