...
public class VerticalArc : OnFloorObject
{
    ...
    void InitializeBuildParameterLines()
    {
        ...
        MainMaterialParam = new MailboxLineMaterial(name: "Main material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
    }
