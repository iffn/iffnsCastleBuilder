...
public class RailingLinear : OnFloorObject
{
    ...
    public override void Setup(IBaseObject linkedFloor)
    {
        ...
        TopMaterialParam = new MailboxLineMaterial(name: "Top material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodSolid);
        BottomMaterialParam = new MailboxLineMaterial(name: "Bottom material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodSolid);
        PostMaterialParam = new MailboxLineMaterial(name: "Post material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodSolid);
    ...
    public override void ApplyBuildParameters()
    {
        ...
        {
            GameObject newPost = GameObject.Instantiate(original: RailingPostTemplate);
