...
public class Counter : OnFloorObject
{
    ...
    public override void Setup(IBaseObject linkedFloor)
    {
        ...
        BaseMaterialParam = new MailboxLineMaterial(name: "Base material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodSolid);
