...
public class HorizontalArc : OnFloorObject
{
    ...
    public override void Setup(IBaseObject linkedFloor)
    {
        ...
        OutsideMaterialParam = new MailboxLineMaterial(name: "Outside material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        InsideMaterialParam = new MailboxLineMaterial(name: "Inside material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        FirstWallMaterialParam = new MailboxLineMaterial(name: "First wall material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        SecondWallMaterialParam = new MailboxLineMaterial(name: "Second wall material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultStoneBricks);
        ...
        FloorMaterialParam = new MailboxLineMaterial(name: "Floor material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodPlanks);
    ...
    public override void ApplyBuildParameters()
    {
        ...
        float wallHeight = base.LinkedFloor.BottomFloorHeight;
        switch (BlockType)
        {
            case BlockTypes.Wall:
                wallHeight = base.LinkedFloor.WallHeightWithScaler;
                break;
            case BlockTypes.Floor:
                wallHeight = base.LinkedFloor.BottomFloorHeight;
                break;
            default:
    ...
    {
        HorizontalArc returnValue = GameObject.Instantiate(ResourceLibrary.TryGetTemplateFromStringIdentifier(HorizontalArc.constIdentifierString) as HorizontalArc);
