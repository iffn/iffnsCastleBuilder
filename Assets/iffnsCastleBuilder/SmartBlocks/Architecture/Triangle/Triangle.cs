...
{
    public const string constIdentifierString = "Triangle";
    ...
    public override void Setup(IBaseObject linkedFloor)
    {
        ...
        TopMaterial = new MailboxLineMaterial(name: "Top material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultWoodPlanks);
        BottomMaterial = new MailboxLineMaterial(name: "Bottom material", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultCeiling);
        MaterialWall12 = new MailboxLineMaterial(name: "Material Wall 1-2", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultPlaster);
        MaterialWall23 = new MailboxLineMaterial(name: "Material Wall 2-3", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultPlaster);
        MaterialWall31 = new MailboxLineMaterial(name: "Material Wall 3-1", objectHolder: CurrentMailbox, valueType: Mailbox.ValueType.buildParameter, DefaultValue: MaterialLibrary.DefaultPlaster);
